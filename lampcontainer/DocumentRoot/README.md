# php-base - PHP Slim 4 Server library for LampDemo
...
------------ | ------------- | ------------- | -------------
*AbstractUserApi* | **userPost** | **POST** /user | Creates a user
*AbstractUserApi* | **userIdGet** | **GET** /user/{id} | Get details of user
*AbstractUserApi* | **userIdPatch** | **PATCH** /user/{id} | Update user


## Models

* OpenAPIServer\Model\InlineResponse409
* OpenAPIServer\Model\User
* OpenAPIServer\Model\Usercreate
